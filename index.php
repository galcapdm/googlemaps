...
<html>
  ...
  <body data-editstatus="">
    ...
    <div id="markerholder" class="btn-action" data-action="hidesplash">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCPb8byuKmAvWrtZUuTDx48N_yINnIjRkQ"
    async defer></script>
